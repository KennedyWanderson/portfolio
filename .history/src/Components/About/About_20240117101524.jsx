    ...
    return(
        <div className="flex h-[77vh] my-24">
            <div className="flex flex-col relative flex-1">
                ...
                <button className="rounded-3xl	border-none	text-white text-base pt-3 p-3 pr-8 pl-6 bg-gradient-to-r from-violet-500 to-fuchsia-500
                hover:cursor-grab bg-white hover:text-orange-500 w-24 h-8 flex justify-center items-center">Hire me</button>
