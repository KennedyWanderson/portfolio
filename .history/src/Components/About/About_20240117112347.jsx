    ...
    <div className="flex h-[77vh] my-24">
      <div className="flex flex-col relative flex-1 gap-8">
        <div className="flex flex-col">
          ...
          <span>Frontend Developer with high level of experience in web development, producing quality work.</span>
        </div>
      ...
      <div className="flex-1 relative">
        <div className="z-1 absolute">
          <img className="scale-75 left-0 top-0" src={Vector1} alt="" />
          <img className="scale-75 left-0 top-0" src={Vector2} alt="" />
          <img className="scale-145 left-0 top-0" src={Profile} alt="" />
        </div>
      </div>
    </div>
  )
