    ...
    return (
        <div className="lg:flex lg:flex-row flex-col h-[77vh] my-20 about">
            <div className="flex flex-col relative flex-1 gap-8">
                ...
                <button href="https://www.linkedin.com/in/kennedy-wanderson/" className="rounded-3xl	border-none	text-white text-base pt-3 p-3 pr-6 pl-6 bg-gradient-to-r from-violet-500 to-fuchsia-500
