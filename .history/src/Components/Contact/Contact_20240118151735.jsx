        ...
        <div className="pt-0 pr-12 pb-0 pl-12 mt-16 flex h-[80vh]">
            ...
            <div className="flex justify-center relative flex-1">
                <form className="flex flex-col gap-8 items-center" action="">
                    ...
                    <input type="submit" value="Send" className="rounded-3xlborder-none	text-white text-base pt-3 p-3 pr-6 pl-6 bg-gradient-to-r from-violet-500 to-fuchsia-500
                hover:cursor-grab bg-white hover:text-orange-500 w-28 h-8 flex justify-center items-center" />
