...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    return(
        <div className="lg:flex flex-col m-3 pt-0 pr-12 pb-0 pl-12 mt-16 flex h-[80vh]">
            <div>
            ...
            <div className="flex justify-center relative">
                <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-8 flex-1 items-center" action="">
