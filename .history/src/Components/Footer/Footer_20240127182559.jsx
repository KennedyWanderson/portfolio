...
const Footer = () => {
    return(
        <div className=" flex items-center mt-[-0.5rem] mb-[-3.5rem] relative">
            ...
            <div className=" flex flex-col items-center justify-center absolute w-full mt-16 sm:gap-6 gap-16 text-white">
                <span className="sm:mt-10">devprogrammer.wiz@gmail.com</span>
