        ...
        <div className="lg:h-[10vh] flex flex-col lg:flex-row justify-between">
            ...
            <div className="lg:flex hidden flex-1 items-center justify-center font-normal">
                ...
                <Link spy={true} to='Contact' smooth={true}>
                    <button spy={true} to='Contact' smooth={true} className=" rounded-3xl border-none text-white text-base pt-3 p-3 pr-6 pl-6 bg-gradient-to-r from-violet-500 to-fuchsia-500
