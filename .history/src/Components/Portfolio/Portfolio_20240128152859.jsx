        ...
        <div className="flex flex-col items-center justify-center h-[70vh] mb-10" id="Projects">
            ...
            >
                <SwiperSlide className="p-2">
                    <img className="w-full h-auto drop-shadow-xl rounded-2xl" src={Admin} alt="" />
                </SwiperSlide>
                <SwiperSlide className="p-2">
                    <img className="w-full h-auto drop-shadow-xl rounded-2xl" src={Burguer} alt="" />
                </SwiperSlide>
                <SwiperSlide className="p-2">
                    <img className="w-full h-auto drop-shadow-xl rounded-2xl" src={Netflix} alt="" />
                </SwiperSlide>
                <SwiperSlide className="p-2">
                    <img className="w-full h-auto drop-shadow-xl rounded-2xl" src={Movie} alt="" />
                </SwiperSlide>
            </Swiper>
        </div>
    );
