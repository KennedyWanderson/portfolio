...
const Services = () => {
    ...
    return (
        ...
        <div className="pt-0 pb-12 pr-3 pl-12 flex h-[90vh] mt-10 sm:mt-0 flex-col gap-20 h-[66rem] p-[0] " id="About">
            ...
            <div className="relative sm:flex flex-col gap-72">
                <div className="left-56 absolute sm:flex flex-col gap-72">
                    <Card
                        emoji={HeartEmoji}
                        heading={'Skills'}
