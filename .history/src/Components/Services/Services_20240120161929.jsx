...
const Services = () => {
    ...
    return (
        ...
        <div className="pt-0 pb-12 pr-3 pl-12 flex h-[90vh] mt-10 sm:mt-0 sm:flex-col sm:gap-20 sm:h-[66rem] sm:p-[0] " id="About">
            ...
            <div className="relative sm:flex sm:flex-col sm:gap-72">
                <div className="left-56 absolute sm:static">
                    <Card
                        emoji={HeartEmoji}
                        heading={'Skills'}
