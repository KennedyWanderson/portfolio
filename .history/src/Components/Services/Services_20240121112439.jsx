...
const Services = () => {
    ...
    return (
        ...
        <div className="pt-0 pb-12 pr-3 pl-12 flex h-[90vh] mt-10 lg:mt-0 lg:flex lg:flex-row flex-col gap-20 h-[66] p-0" id="About">
            ...
            <div className="relative lg:flex lg:flex-row flex-col gap-72">
                <div className="left-56 absolute lg:static">
                    <Card
                        emoji={HeartEmoji}
                        heading={'Skills'}
